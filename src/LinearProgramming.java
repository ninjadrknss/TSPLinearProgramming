...
public class LinearProgramming {
    ...
    public static void main(String[] args) {
        ...
        if (loc == Regions.SOUTH_AMERICA) {
            System.out.println("# Subtour elimination constraints (DFJ)");
            int n = 1;
            ...
            sets[0]  = new Region[]{US.State.NewYork, US.State.Vermont, US.State.Maine, US.State.NewHampshire, US.State.Massachusetts, US.State.RhodeIsland, US.State.Connecticut};
            sets[1]  = new Region[]{US.State.NewYork, US.State.Vermont, US.State.Maine, US.State.NewHampshire, US.State.Massachusetts, US.State.RhodeIsland, US.State.Connecticut, US.State.NewJersey};
            sets[2]  = new Region[]{US.State.NewYork, US.State.Vermont, US.State.Maine, US.State.NewHampshire, US.State.Massachusetts, US.State.RhodeIsland, US.State.Connecticut, US.State.NewJersey, US.State.Delaware, US.State.Maryland, US.State.Pennsylvania};
            sets[3]  = new Region[]{US.State.Maryland, US.State.Delaware, US.State.Virginia};
            sets[4]  = new Region[]{US.State.California, US.State.Oregon, US.State.Washington, US.State.Idaho, US.State.Montana, US.State.NorthDakota, US.State.SouthDakota, US.State.Wyoming, US.State.Colorado, US.State.NewMexico, US.State.Arizona, US.State.Utah, US.State.Nevada};
            sets[5] = new Region[]{US.State.California, US.State.Oregon, US.State.Washington, US.State.Idaho, US.State.Montana, US.State.Utah, US.State.Wyoming, US.State.Colorado, US.State.NewMexico, US.State.Arizona, US.State.Nevada};
            ...
            sets[9] = new Region[]{US.State.Wisconsin, US.State.Michigan, US.State.Ohio, US.State.WestVirginia, US.State.Pennsylvania, US.State.NewYork, US.State.Vermont, US.State.Maine, US.State.NewHampshire, US.State.Massachusetts, US.State.RhodeIsland, US.State.Connecticut, US.State.NewJersey, US.State.Delaware, US.State.Maryland, US.State.Virginia, US.State.NorthCarolina, US.State.SouthCarolina, US.State.Florida, US.State.Alabama, US.State.Georgia, US.State.Tennessee, US.State.Kentucky, US.State.Indiana, US.State.Illinois};
        ...
        EdgePlot.main(new String[]{loc.toString()});
    }
